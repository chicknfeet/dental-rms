                ...
                @foreach ($paymentinfo as $payment)
                    <tr class="bg-white border-b hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a href="{{ route('admin.deletePayment', $payment->id) }}" class="px-4 py-2 rounded text-red-800 hover:bg-red-200 transition duration-300 text-base" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this payment?')) { document.getElementById('delete-payment-form-{{ $payment->id }}').submit(); }">
